...
def sentimentAnalysisArticles():
    ...
    scores = parsed_and_scored_news['headline'].apply(classifier.polarity_scores).tolist()
    ...
    parsed_and_scored_news.to_csv('opinionVals.csv')
...
def sentimentAnalysisTweets():
    ...
    scores = parsed_and_scored_tweets['text'].apply(classifier.polarity_scores).tolist()
